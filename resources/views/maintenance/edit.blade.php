                    ...
                    <form action="{{ route('maintenance.update', $maintenance) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="equipment_name" id="equipment_name" value="{{ old('equipment_name', $maintenance->equipment_name) }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="maintenance_date" id="maintenance_date" value="{{ old('maintenance_date', $maintenance->maintenance_date->format('Y-m-d')) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500" required>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4"
                                          ...
                                          placeholder="Describe the maintenance work to be performed..." required>{{ old('description', $maintenance->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
